  ...
  <div id="carouselExampleIndicators" class="carousel slide main-slider" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset ('images/sliders/connect3.jpg') }}" class="d-block w-100">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to your Business Connect Platform</h3>
          <p>
      ...
      <div class="carousel-item">
        <img src="{{ asset ('images/sliders/connect4.jpg') }}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to your Business Connect Platform</h3>
          <p>
      ...
      <div class="carousel-item">
        <img src="{{ asset ('images/sliders/connect1.jpg') }}" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h3>Welcome to your Business Connect Platform</h3>
          <p>
            <a href="" class="btn btn-primary slider-link">
